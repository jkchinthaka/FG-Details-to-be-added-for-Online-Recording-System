...
import { Alert, Button, FormErrorSummary, Input, StickyMobileActionBar } from "@nelna/ui";
...
export function ChangePasswordForm() {
  ...
  return (
    <div
      ...
      style={{ background: "var(--nelna-surface-muted)" }}
    >
      <div className="w-full max-w-md" style={{ width: "min(100%, 28rem)" }}>
        ...
        <p
          ...
          style={{ color: "var(--nelna-text-secondary)" }}
        >
          Need help? Contact your Nelna Farm system administrator.
        </p>
        ...
        >
          ...
          <StickyMobileActionBar hint="Use a unique password you do not reuse elsewhere.">
