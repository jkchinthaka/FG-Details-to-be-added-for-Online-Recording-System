...
export default function OfflineFallbackPage() {
  return (
    <main className="mx-auto flex min-h-dvh max-w-lg flex-col justify-center gap-3 px-4 py-10">
      <h1
        className="text-nelna-primary-dark text-2xl font-bold"
        style={{ fontFamily: "var(--nelna-font-display)" }}
      >
        You are offline
      </h1>
      <p className="text-sm" style={{ color: "var(--nelna-text-secondary)" }}>
        Nelna FG keeps local drafts on this device. Work is not marked submitted until the
        server confirms sync.
      </p>
      <Link href="/tasks" className="text-nelna-primary font-semibold">
