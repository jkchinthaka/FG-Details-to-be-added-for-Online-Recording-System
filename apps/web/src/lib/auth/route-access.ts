...
export const ROUTE_ACCESS_RULES: RouteAccessRule[] = [
  { prefix: "/admin", roles: ["SYSTEM_ADMINISTRATOR"], permissions: ["users:manage", "master_data:manage", "templates:manage"] },
  { prefix: "/reports", roles: ["QA_EXECUTIVE", "FOOD_SAFETY_TEAM_LEADER", "AUDITOR", "SYSTEM_ADMINISTRATOR", "FG_SUPERVISOR"], permissions: ["reports:read", "audit:read", "records:check"] },
  { prefix: "/records/pending-check", roles: ["FG_SUPERVISOR", "SYSTEM_ADMINISTRATOR"], permissions: ["records:check"] },
  { prefix: "/records/pending-verification", roles: ["QA_EXECUTIVE", "FOOD_SAFETY_TEAM_LEADER", "SYSTEM_ADMINISTRATOR"], permissions: ["records:verify"] },
  { prefix: "/corrective-actions", roles: ["FG_SUPERVISOR", "QA_EXECUTIVE", "FOOD_SAFETY_TEAM_LEADER", "AUDITOR", "SYSTEM_ADMINISTRATOR"], permissions: ["corrective_actions:read", "corrective_actions:manage"] },
  { prefix: "/records/new", roles: ["FG_OPERATOR", "FG_SUPERVISOR"], permissions: ["records:create"] },
...
export function canAccessRoute(
  ...
  if (rule.permissions?.some((permission) => permissions.includes(permission))) return true;
  return false;
}
